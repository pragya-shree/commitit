...
export const RegisterPage: React.FC<RegisterPageProps> = ({ onToggleLogin }) => {
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)] w-full items-center justify-center px-4 py-6 sm:py-8 relative overflow-hidden select-none">
              ...
              <div>
                ...
                <div className="relative group/input">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/[0.05] bg-void-950/45 py-3 pl-11 pr-4 text-slate-200 placeholder-slate-600 outline-none focus:border-magenta/40 focus:ring-2 focus:ring-magenta/5 hover:border-white/[0.12] transition duration-200 text-sm font-body shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]"
                  />
                </div>
              </div>
