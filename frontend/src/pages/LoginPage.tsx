        ...
        <div className="relative group rounded-2xl p-[1px] bg-gradient-to-r from-white/[0.08] via-white/[0.03] to-white/[0.08] hover:from-coral/25 hover:via-magenta/25 hover:to-violet/25 transition-all duration-500 shadow-[0_0_40px_-15px_rgba(139,92,246,0.2)]">
          <div className="relative rounded-2xl bg-void-900/70 p-8 backdrop-blur-2xl border border-white/[0.02]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider font-body">
                    Password
                  </label>
                  <button
                    type="button"
                    onClick={() => setShowForgotPassword(true)}
                    className="text-xs text-coral hover:text-coral-light hover:underline transition font-body cursor-pointer"
                  >
                    Forgot Password?
                  </button>
                </div>
                <div className="relative group/input">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full rounded-xl border border-white/[0.05] bg-void-950/45 py-3 pl-11 pr-11 text-slate-200 placeholder-slate-600 outline-none focus:border-violet/40 focus:ring-2 focus:ring-violet/5 hover:border-white/[0.12] transition duration-200 text-sm font-body shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)]"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between text-xs text-slate-400 font-body">
                <button
                  ...
                  className="flex items-center gap-2 cursor-pointer hover:text-slate-300 transition"
                >
                  {rememberMe ? (
            ...
            <button
              ...
              disabled={isSubmitting}
              className="w-full rounded-xl border border-white/[0.08] bg-void-950/40 py-3 text-xs font-semibold text-slate-200 hover:bg-white/[0.04] hover:border-white/[0.15] transition duration-200 flex items-center justify-center gap-2.5 cursor-pointer font-body shadow-sm"
            >
